...
class ObituaryDbSqlMapper implements ObituaryMapperInterface {
    ...
    AdapterInterface $dbAdapter, HydratorInterface $hydrator = null, \Application\Model\Entity\ObituaryInterface $postPrototype = null
    ) {
