...
class CommunityDbSqlMapper implements CommonMapperInterface {
    ...
    AdapterInterface $dbAdapter, HydratorInterface $hydrator = null, \Application\Model\Entity\CommunityInterface $postPrototype = null
    ) {
