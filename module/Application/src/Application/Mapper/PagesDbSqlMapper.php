...
class PagesDbSqlMapper implements PagesMapperInterface {
    ...
    AdapterInterface $dbAdapter, HydratorInterface $hydrator = null, \Application\Model\Entity\PagesInterface $postPrototype = null
    ) {
