...
class PostsDbSqlMapper implements PostsMapperInterface {
    ...
    AdapterInterface $dbAdapter, HydratorInterface $hydrator = null, \Application\Model\Entity\PostsInterface $postPrototype = null
    ) {
