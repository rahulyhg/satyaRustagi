...
class JustbornDbSqlMapper implements JustbornMapperInterface {
    ...
    AdapterInterface $dbAdapter, HydratorInterface $hydrator = null, \Application\Model\Entity\JustbornInterface $postPrototype = null
    ) {
