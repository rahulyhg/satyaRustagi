...
class PersonalDetails implements PersonalDetailsInterface {
    ...
    public function exchangeArrayTable($data) {
        ...
        $userData['id'] = (null !== $data->id) ? $data->id : null;
        $userData['profile_for'] = (null !== $data->profile_for) ? $data->profile_for : null;
        $userData['profile_for_others'] = (null !== $data->profile_for_others) ? $data->profile_for_others : null;
        $userData['name_title_user'] = (null !== $data->name_title_user) ? $data->name_title_user : null;
        $userData['full_name'] = (null !== $data->full_name) ? $data->full_name : null;
        $userData['alternate_mobile_no'] = (null !== $data->alternate_mobile_no) ? $data->alternate_mobile_no : null;
        $userData['phone_no'] = (null !== $data->phone_no) ? $data->phone_no : null;
        $userData['gender'] = (null !== $data->gender) ? $data->gender : null;
        $userData['native_place'] = (null !== $data->native_place) ? $data->native_place : null;
        $userData['address'] = (null !== $data->address) ? $data->address : null;
        $userData['address_line2'] = (null !== $data->address_line2) ? $data->address_line2 : null;
        $userData['country'] = (null !== $data->country) ? $data->country : null;
        $userData['state'] = (null !== $data->state) ? $data->state : null;
        $userData['city'] = (null !== $data->city) ? $data->city : null;
        $userData['zip_pin_code'] = (null !== $data->zip_pin_code) ? $data->zip_pin_code : null;
        $userData['dob'] = (null !== $data->dob) ? $data->dob : null;
        $userData['age'] = (null !== $data->age) ? $data->age : null;
        $userData['any_disability'] = (null !== $data->any_disability) ? $data->any_disability : null;
        $userData['color_complexion'] = (null !== $data->color_complexion) ? $data->color_complexion : null;
        $userData['body_type'] = (null !== $data->body_type) ? $data->body_type : null;
        $userData['height'] = (null !== $data->height) ? $data->height : null;
        $userData['blood_group'] = (null !== $data->blood_group) ? $data->blood_group : null;
        //$this->marital_status = (null!==$data->marital_status) ? $data->marital_status : null;
        $userData['gothra_gothram'] = (null !== $data->gothra_gothram) ? $data->gothra_gothram : null;
        $userData['gothra_gothram_other'] = (null !== $data->gothra_gothram_other) ? $data->gothra_gothram_other : null;
        $userData['religion'] = (null !== $data->religion) ? $data->religion : null;
        $userData['religion_other'] = (null !== $data->religion_other) ? $data->religion_other : null;
        return $userData;
    }
